...
public class CreditoModelTrainer
{
    ...
    public void AvaliarMelhorModelo()
    {
        ...
        Console.WriteLine("Executando o AutoML...");
        var resultadoExperiment = experiment.Execute(dados, labelColumnName: nameof(CreditoInputData.Aprovado));

        var melhorExecucao = resultadoExperiment.BestRun;

        Console.WriteLine($"Melhor Algoritmo: {melhorExecucao.TrainerName}");    
        Console.WriteLine($"Melhor Acurácia: {melhorExecucao.ValidationMetrics.Accuracy:P2}");
        Console.WriteLine($"Melhor Precisão: {melhorExecucao.ValidationMetrics.PositivePrecision:P2}");
        Console.WriteLine($"Melhor Recall: {melhorExecucao.ValidationMetrics.PositiveRecall:P2}");
        Console.WriteLine($"Melhor F1 Score: {melhorExecucao.ValidationMetrics.F1Score:P2}");
